            ...
            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><center><a href="magaza-onay-islemleri.php?kullanici_id=<?php echo $takekUser['kullanici_id']; ?>"><button class="btn btn-primary btn-xs">Mağaza İnceleme</button></a></center></td>
