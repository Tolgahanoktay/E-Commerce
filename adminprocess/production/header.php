        ...
        <div class="left_col scroll-view">
          ...
          <div class="profile clearfix">
            ...
            <div class="profile_info">
              <span>Hoşgeldin</span>
              <h2><?php echo $takeUser['kullanici_adSoyad'] ?></h2>
            </div>
          </div>
          <!-- /menu profile quick info -->
          ...
          <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            ...
            <li><a href="shop-confirm.php"><i class="fa fa-shopping-basket"></i>Mağaza İşlemleri </a></li>



             <li><a href="user.php"><i class="fa fa-user"></i> Kullanıcılar </a></li>

             <li><a href="products.php"><i class="fa fa-shopping-basket"></i> Ürünler </a></li>
        ...
        <ul class="nav navbar-nav navbar-right">
          <li class="">
            <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
              <img src="images/img.jpg" alt=""><?php echo $takeUser['kullanici_adSoyad'] ?>
